...
\titolo{Creazione, scambio, vendita e logica di NFT sulla blockchain Flow}
...
\lstdefinestyle{cadence}{
    ...
    classoffset=0,
    % escapechar=\&,
    morekeywords=[1]{,pub,emit,pre,post,execute,return,create,import,from,prepare,}, % Python builtin
    morekeywords=[2]{,contract,resource,transaction,interface,access,let,var,UFix64,UInt64,}, % Python builtin
...
\capitolo{DDD-NFT}{capitoli/dddnft}
